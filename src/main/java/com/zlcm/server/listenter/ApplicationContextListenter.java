package com.zlcm.server.listenter;

import com.zlcm.server.annotation.BaseService;
import com.zlcm.server.base.BaseInterface;
...
public class ApplicationContextListenter implements ApplicationListener<ContextRefreshedEvent> {

    private Logger _log = LoggerFactory.getLogger(ApplicationContextListenter.class);
